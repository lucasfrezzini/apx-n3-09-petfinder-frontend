  ...
  return (
    <div className=" px-5 py-(--padding-section)">
      <nav aria-label="Footer" className="flex flex-wrap gap-6 justify-center">
        <Link to="/" className="text-dark transition-colors hover:text-primary">
          Inicio
        </Link>
        <Link
          to="/create-pet-report"
      ...
      <div className="flex flex-wrap mt-8 gap-6 justify-center">
        <a
          href="https://www.linkedin.com/in/lucasfrezzini/"
          target="_blank"
          className="size-6 transition-colors hover:text-primary"
        >
          <span className="hidden sr-only">Linkedin</span>
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            aria-hidden="true"
        ...
        <a
          href="https://www.instagram.com/lucasfrezzini/"
          target="_blank"
          className="size-6 transition-colors hover:text-primary"
        >
        ...
        <a
          href="https://github.com/lucasfrezzini"
          target="_blank"
          className="size-6 transition-colors hover:text-primary"
        >

  ...
  return (
    <div className=" px-5 py-(--padding-section)">
      ...
      <div className="flex flex-wrap mt-8 gap-6 justify-center">
        <a href="#" className="size-6 transition-colors hover:text-primary">
          <span className="hidden sr-only">Facebook</span>
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a href="#" className="size-6 transition-colors hover:text-primary">
          <span className="hidden sr-only">Instagram</span>
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a href="#" className="size-6 transition-colors hover:text-primary">
          <span className="hidden sr-only">X</span>
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a href="#" className="size-6 transition-colors hover:text-primary">
          <span className="hidden sr-only">GitHub</span>
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a href="#" className="size-6 transition-colors hover:text-primary">
          <span className="hidden sr-only">YouTube</span>
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
